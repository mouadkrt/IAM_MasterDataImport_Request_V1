...
# mvn clean install
# Start Docker deamon
# docker build -t quay.io/msentissi/muis-fuse-masterdataimport_request_v1-transformation:iam_1.11-prod .
# Tag it and push to quay
# docker tag muis-fuse-masterdataimport_request_v1-transformation:iam_1.11-prod quay.io/msentissi/muis-fuse-masterdataimport_request_v1-transformation:iam_1.11-prod
# docker login quay.io
# docker push quay.io/msentissi/muis-fuse-masterdataimport_request_v1-transformation:iam_1.11-prod